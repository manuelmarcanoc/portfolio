...
const sections: Section[] = [
    { id: 'github', label: 'GitHub', icon: GithubIcon, isLink: true, url: portfolioData.githubUrl, position: { top: '50%', right: '0%', transform: 'translate(50%, -50%)' } },
    { id: 'experience', label: 'Experiencia', icon: BriefcaseIcon, position: { top: '15%', right: '15%', transform: 'translate(50%, -50%)' } },
    { id: 'cv', label: 'Descargar CV', icon: DownloadIcon, isLink: true, url: portfolioData.cvUrl, position: { top: '0', left: '50%', transform: 'translate(-50%, -50%)' } },
    ...
    { id: 'languages', label: 'Idiomas', icon: LanguagesIcon, position: { top: '15%', left: '15%', transform: 'translate(-50%, -50%)' } },
];
